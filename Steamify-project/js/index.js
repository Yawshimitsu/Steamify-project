            ...
            const html = data
                ...
                <div class="tab_item">
                    ...
                    <div class="wrap-content">
                        ...
                        <div class="pricing">
                            <h4 class="dealrating"> ${item && item.dealRating}%</h4>
                            <h4 class="normalPrice"> ${item && item.normalPrice}$</h4>
                        </div>
                    </div>
                </div>
            `;
...
const burger = document.querySelector('.hamburger').addEventListener('click', function () {
